...
Coord.prototype.SendCoord = function (order) {
  this.coordinates[c.orderId] = order;
};

Coord.prototype.getAllCoord = function () {
...
io.on('connection', function (socket) {
  ...
  socket.on('SendCoord', function (order) {
    c.SendCoord(order);
    io.emit('SendCoordinates', { coordinates: c.getAllCoord() });
  });
